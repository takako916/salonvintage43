            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 text-gray-300">
                <a
                  ...
                  aria-label="Instagram Vintage le Salon"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <span className="text-sm">{event.instagramHandle ?? "@vintagelesalon43"}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {event.year ?? new Date().getFullYear()} {event.name}. Tous droits réservés.
            </p>
          ...
          {/* Production Directe Logo & Social Links */}
          <div className="flex flex-col items-center mt-8 pt-6 border-t border-gray-700">
            <div className="flex items-center gap-4 mb-3">
              ...
              />
              <span className="text-gray-300 text-sm font-medium">Production Directe</span>
            </div>
            
            <div className="flex items-center gap-4">
              <a
                href="https://www.facebook.com/productiondirecte"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-400 transition-colors"
                aria-label="Facebook Production Directe"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
              ...
              <a
                href="https://www.instagram.com/productiondirecte"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-pink-400 transition-colors"
                aria-label="Instagram Production Directe"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
